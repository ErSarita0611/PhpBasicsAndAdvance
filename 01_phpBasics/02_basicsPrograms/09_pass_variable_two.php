...
<table>
<form method="POST" action="10_pass_variable_tree.php"> 
	
	<pre> 
		Company/College: <input type="text" name="college_name"> 
	</pre> 
	...
	<pre> 
		...
		<input type="radio" name="profession"
				value="Working Professional"> Working Professional 
	</pre> 
	...
	<pre> 
		<input type="checkbox"
			name="terms_and_conditions"> Terms and Conditions 
	</pre> 
	<br> 
	<pre>
